{
  ...
  outputs = {
    ...
    in {
      packages.default = pythonSet.mkVirtualEnv "nilai-vibe-env" workspace.deps.default;
        ...
        default = let
          ...
          editablePythonSet = pythonSet.overrideScope (
            lib.composeManyExtensions [
              ...
              (final: prev: {
                nilai-vibe = prev.nilai-vibe.overrideAttrs (old: {
          ...
          virtualenv = editablePythonSet.mkVirtualEnv "nilai-vibe-dev-env" workspace.deps.all;
        in
          pkgs.mkShell {
            packages = [
              virtualenv
